...
<form id="welcome_form" action="/torrentwatch/index.cgi">
  ...
  <div id="welcome-2" class="dialog_window welcome">
    ...
    <div class="form_radio">
      <input type="radio" name="client" value="btpd" />
      <label class="item">BTPD*</label>
    </div>
    <div class="form_radio">
      <input type="radio" name="client" value="transmission1.22" />
      <label class="item">Transmission 1.22*</label>
    </div>
    <div class="form_radio">
      <input type="radio" name="client" value="transmission1.3x" />
    ...
    <div class="form_radio">
      <input type="radio" name="client" value="nzbget" />
      <label class="item">NZBGet*</label>
    </div>
    <div class="form_radio">
      <input type="radio" name="client" value="sabnzbd" />
  ...
  <div id="welcome-3" class="dialog_window welcome">
    ...
    <label class="category">Bit Torrent</label>
    <div class="form_radio">
      <input type="radio" name="link" value="http://tvrss.net/feed/eztv/" /><label class="item">tvRSS.net - EzTV</label>
      <label class="item">The EzTV feed from tvRSS.net</label>
    </div>
    <div class="form_radio">
      <input type="radio" name="link" value="http://tvrss.net/feed/vtv/" /><label class="item">tvRSS.net - VTV</label>
      <label class="item">The VTV feed from tvRSS.net contains only the most popular tv shows</label>
    </div>
    <label class="category">NZB</label>
    <div class="form_radio">
      <input type="radio" name="link" value="http://www.tvnzb.com/tvnzb.rss" /><label class="item">TvNZB.com</label>
      <label class="item">TvNZB.com offers a feed of user submitted .nzb files</label>
    </div>
    <div class="form_radio">
      <input type="radio" name="link" value="http://tvbinz.net/rss.php" /><label class="item">TVBINZ.NET</label>
  ...
  <div id="welcome-5" class="dialog_window welcome">
    ...
    <input type="checkbox" name="onlynewer" value="1" checked="checked" />
      Newer Episodes Only
    </label>
    ...
    <label class="category">
      <input type="checkbox" name="verifyepisodes" value="1" checked="checked" />
      Verify Episodes
    </label>
      <label class="item">Only download each episode once.  So if previously S01E13 had been downloaded, a second copy of S01E13 showing up in a feed will not be downloaded.  Items tagged Proper or Repack are an exception to this setting.  Note that this depends on the name being spelled the same between feeds.</label>
    <label class="category">
