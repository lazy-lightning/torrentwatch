$(function() { 
    ...
    $.get('index.cgi/ajax', '', $.loadDynamicData, 'html');
        ...
        this.contextMenu("CM1", {
            bindings: {
                ...
                'inspect': function(t) {
                    ...
                    $.get('index.cgi/inspector/ajax', 'title=' + encodeURIComponent($(t).find("span.torrent_name").text()), function(html) {
                        var submitInspector = function(e) {
                            e.stopImmediatePropagation();
                            $.get('index.cgi/inspector/ajax', 'title=' + encodeURIComponent($("#inspector_container input").val()), function(html) {
