<?php
	...
	class TV_Show extends TVDB {
      ...
      if(!$episode = DataCache::Get(__CLASS__.__FUNCTION__, "{$this->id}_${season}_${episode}")) {
  			...
  			if ($data) {
  				...
  				$episode = new TV_Episode($xml->Episode);
  			} else {
  				return false;
  			}
        DataCache::Put(__CLASS__.__FUNCTION__, "{$this->id}_${season}_${episode}", 60*60*24*30, $episode);
  		}
      return $episode;
    }
	}
